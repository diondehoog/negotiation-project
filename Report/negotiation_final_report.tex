...
We confirm this by letting simple agent play against Boulware. In these tests the simpleagent obtains an average utility of $0.6$ while the Boulware agent scores on average $1.0$. Finally, we play with the Boulware agent against the conceder agent. A typical negotiation trace is displayed below: \\

\begin{figure}[H]
\begin{center}
 \includegraphics[width=1.0\textwidth]{traceConcederBoulware.png}
